...
\addtobacksidebar{
    ...
    Como Candidato a Magíster en Ingeniería de Software por la Universidad de los Andes, complemento mi experiencia técnica con conocimientos avanzados en arquitectura ágil, desarrollo nativo en la nube, pruebas automatizadas y prácticas DevOps.\\
...
\begin{cvtable}[1.5]
    \cvitem{2024--Actualmente\centering}{Maestría en Ingeniería de Software}{Universidad de los Andes}{Candidato a Magíster en Ingeniería de Software. Perfil enfocado en la arquitectura ágil, diseño de software y gerencia de proyectos. Experiencia académica avanzada en el ciclo completo de desarrollo, abarcando desde aplicaciones móviles y web hasta implementaciones nativas en la nube con integración y despliegue continuo.}
